        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" style="min-height: 85vh;">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <p class="breadcrumbs">
                    ...
                    <span>Visit Sri Lanka <i class="fa fa-chevron-right"></i></span>
                </p>
                <h1 class="mb-0 bread">Visit Sri Lanka</h1>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                                        ...
                                        <div class="tour-card-v3__footer-top">
                                            <div style="min-width:0;">
                                                <h3 class="tour-card-v3__title">
                                                    <a href="{{ route('frontend.single_tour', $tour) }}">
                                                        {{ $tour->title }}
                                                    </a>
                                                </h3>
                                                <p class="tour-card-v3__subtitle">
                                                    {{ $tour->duration }} Nights, {{ $locationName }}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tour-card-v3__bottom">
                                        <div class="tour-card-v3__price-wrap">
                                            ...
                                            <span class="tour-card-v3__price">
                                                From {{ $tour->currency ?? 'USD' }} {{ number_format((float) $displayPrice, 0) }} PP
                                            </span>
                                        </div>
                                        <a href="{{ route('frontend.single_tour', $tour) }}"
                    ...
                    @else
                        <div class="col-12">
                            <p class="text-center">No inbound tours found matching your search.</p>
                        </div>
                    @endif
                </div>

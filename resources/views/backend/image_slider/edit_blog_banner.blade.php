    ...
    <div class="section-block">
        <div class="card">
            ...
            <div class="card-header" style="padding:18px 22px 0;">
                <div>
                    <div class="card-header-title">Edit Blog Banner</div>
                    <div class="card-header-sub">Update the blog banner image</div>
                </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.blog_banners.update', $blogBanner) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div style="display:flex; justify-content:flex-end; gap:10px;
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Update Blog Banner
                        </button>
                    </div>
                </form>
            </div>

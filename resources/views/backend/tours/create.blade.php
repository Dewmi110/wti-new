                    ...
                    <div class="form-grid-2">
                        <div class="form-group">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <input type="text" name="title"
                                    ...
                                    placeholder="e.g. Bali Island Escape 7D6N" value="{{ old('title') }}">
                            </div>
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <input type="text" name="slug" class="form-input" placeholder="auto-generated-slug"
                                    value="{{ old('slug') }}">
                            </div>
                ...
                <div class="card-body" style="display:flex; flex-direction:column; gap:16px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="tour-destination-picker">
                            ...
                            <div id="destinationsDropdownMenu" class="destination-dropdown-menu">
                            </div>
                        </div>

                        <div class="form-hint">
                            Select a country first to load destinations
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-icon-wrap">
                                ...
                                <input type="search" id="featureSearchInput" class="form-input"
                                    placeholder="Type Beach, Adventure, Camping, Family Friendly..." autocomplete="off">
                            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="highlight-activities" style="display:flex; flex-direction:column; gap:10px;">
                        ...
                        <div class="highlight-activity-row" style="display:flex; align-items:center; gap:10px;">
                            <div class="input-icon-wrap" style="flex:1;">
                                <i class="fas fa-grip-lines input-icon"></i>
                                <input type="text" name="highlight_activities[{{ $loop->index }}]" class="form-input"
                                    placeholder="e.g. Snorkeling at coral reef" value="{{ $highlightActivity }}">
                            </div>
                    ...
                    <div id="itineraries" style="display:flex; flex-direction:column; gap:12px;">
                        ...
                        <div class="itinerary-row"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="itineraries[0][day]" class="form-input" placeholder="1">
                            </div>
                            <div class="form-group">
                                <label class="form-label">Description</label>
                                <textarea name="itineraries[0][description]" class="form-textarea"
                                    style="min-height:70px;" placeholder="Describe the day's activities..."></textarea>
                            </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <label class="file-upload" for="gallery_images_input">
                            <input id="gallery_images_input" type="file" name="images[]" accept="image/*" multiple
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-grid-2">
                        ...
                        {{-- OneSnap Price --}}
                        <div class="form-group">
                            <label class="form-label">OneSnap Price</label>
                            <input type="number" step="0.01" min="0" name="os_price"
                                class="form-input @error('os_price') is-invalid @enderror" value="{{ old('os_price') }}"
                                placeholder="Enter OneSnap price">
                        ...
                        {{-- OneSnap Visibility --}}
                        <div class="form-group">
                            <label class="form-label">OneSnap Visibility</label>

                            <select name="os_visibility"
                                class="form-input @error('os_visibility') is-invalid @enderror">

                                <option value="1" {{ old('os_visibility', 1)==1 ? 'selected' : '' }}>
                                    Visible
                                </option>

                                <option value="0" {{ old('os_visibility', 1)==0 ? 'selected' : '' }}>
                                    Hidden
                                </option>
                            </select>
                        ...
                        {{-- OneSnap Currency --}}
                        <div class="form-group">
                            <label class="form-label">OneSnap Currency</label>

                            <select name="os_currency" class="form-input">
                                <option value="USD" {{ old('os_currency', 'USD' )=='USD' ? 'selected' : '' }}>
                                    USD
                                </option>

                                <option value="Rs" {{ old('os_currency', 'USD' )=='Rs' ? 'selected' : '' }}>
                                    Rs
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="form-group" style="margin-top:20px;">
                        ...
                        <div style="margin-top:6px;">
                            <div class="toggle-wrap">
                                ...
                                <label class="toggle">
                                    <input type="checkbox" name="status" value="1" {{ $canToggle ? '' : 'disabled' }}>

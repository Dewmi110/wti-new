<x-layout bodyClass="bg-gray-200">
        ...
        <div class="container position-sticky z-index-sticky top-0">
            <div class="row">
                <div class="col-12">
                    <!-- Navbar -->
                    <x-navbars.navs.guest signin='admin.login' signup='frontend.index'></x-navbars.navs.guest>
                    <!-- End Navbar -->
                </div>
            </div>
        </div>
                    ...
                    <div class="row signin-margin">
                        <div class="col-lg-4 col-md-8 col-12 mx-auto">
                            <div class="card z-index-0 fadeIn3 fadeInBottom">
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('admin.login.post') }}" class="text-start">
                                        @csrf

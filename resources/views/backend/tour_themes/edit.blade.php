				...
				<div class="col-lg-6 col-md-8 mx-auto">
					<div class="card">
						...
						<div class="card-body pt-4 p-3">
							...
							@endif
							<form method="POST" action="{{ route('admin.tour-themes.update', $item) }}">
								@csrf
								@method('PUT')
								<div class="input-group input-group-outline mt-3">
									<label class="form-label">Theme Name</label>
									<input type="text" name="theme_name" class="form-control" value="{{ old('theme_name', $item->theme_name) }}">
								</div>

				...
				<div class="col-lg-6 col-md-8 mx-auto">
					<div class="card">
						...
						<div class="card-body pt-4 p-3">
							...
							@endif
							<form method="POST" action="{{ route('admin.tour-categories.update', $item) }}">
								@csrf
								@method('PUT')
								<div class="input-group input-group-outline mt-3">
									<label class="form-label">Category Name</label>
									<input type="text" name="category_name" class="form-control" value="{{ old('category_name', $item->category_name) }}">
								</div>

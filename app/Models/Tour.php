...
class Tour extends Model
{
    ...
    protected $fillable = [
        't_category', 't_type', 't_theme', 'title', 'slug', 'description', 'duration', 'country', 'destinations', 'price', 'discount_price', 'highlight_activities', 'banner_img_path', 'visibility', 'status',
    ];
